...
')
     ...
     */ 
        ...
        {
                        /** @var \Modules\Seo\MetaTags\Meta $instance */
        ...
        public static function macro($name, $macro)
        {
                        \Modules\Seo\MetaTags\Meta::macro($name, $macro);
        }
                    /**
         * Mix another object into the class.
         *
        ...
        public static function mixin($mixin, $replace = true)
        {
                        \Modules\Seo\MetaTags\Meta::mixin($mixin, $replace);
        }
                    /**
         * Checks if macro is registered.
         *
        ...
        public static function hasMacro($name)
        {
                        return \Modules\Seo\MetaTags\Meta::hasMacro($name);
        }
                    /**
         * Flush the existing macros.
         *
        ...
        public static function flushMacros()
        {
                        \Modules\Seo\MetaTags\Meta::flushMacros();
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function setMetaFrom($object)
        {
                        /** @var \Modules\Seo\MetaTags\Meta $instance */
                        return $instance->setMetaFrom($object);
        }
                    /**
         * 
         *
         ...
         *
         * @param \Modules\Seo\MetaTags\Paginator $paginator
         * @return \Modules\Seo\MetaTags\Meta 
         * @static 
         */ 
     ...
     */ 
        ...
        {
                        /** @var \Modules\Seo\Packages\Manager $instance */
...
namespace  { 
            ...
            class Meta extends \Modules\Seo\Facades\Meta {}
            class PackageManager extends \Modules\Seo\Facades\PackageManager {}
