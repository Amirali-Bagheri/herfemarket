    ...
    <div class="intro-y col-span-12 overflow-auto lg:overflow-visible" style="overflow: auto;">
        ...
        <table class="table table-report -mt-2">
            <thead>
                <tr>
                    <th class="text-center whitespace-no-wrap">
                        <input type="checkbox" class="form-check-input mr-2" @if(count($selected)===$businesses->total()) checked
            ...
            <tbody>
                ...
                <tr class="intro-x">
                    <td>
                        <input type="checkbox" class="form-check-input mr-2" wire:model="selected" value="{{ $business->id }}">
                    ...
                    <td class="table-report__action w-40 text-center">
                        ...
                        <a style="margin: 5px;" href="javascript:void(0)" wire:click="destroy({{$business->id}})" {{--                           href="{{route('admin.businesses.delete',$business->id)}}"--}}>
