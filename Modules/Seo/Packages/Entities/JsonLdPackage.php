...
namespace Modules\Seo\Packages\Entities;

use Modules\Seo\Contracts\Packages\Entities\JsonLdPackageInterface;

/**
 * @see https://developer.twitter.com/en/docs/tweets/optimize-with-cards/overview/summary.html
 */
class JsonLdPackage implements JsonLdPackageInterface
{
