        ...
        <table class="table table-report -mt-2">
            <thead>
                <tr>
                    ...
                    <th class="text-center whitespace-no-wrap">
                        <a wire:click.prevent="sortBy('tracking_code')" role="button" href="javascript:void(0)">
                            کد پیگیری
                            @include('admin.layouts.livewire_sort_icon', ['field' => 'tracking_code'])
                        </a>
                    </th>
                ...
                @forelse ($payments as $payment)
                    ...
                    <tr class="intro-x">
                        ...
                        <td class="text-center"><a
                                href="{{route('admin.users.show',$payment->user_id)}}">{{$payment->user->full_name}}</a></td>
                        ...
                        <td class="text-center">{{number_format($payment->price)}} ریال</td>
