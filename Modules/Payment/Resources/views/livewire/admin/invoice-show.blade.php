                ...
                <div class="intro-y col-span-12 lg:col-span-6">
                    <div class="lg:text-right mt-10 lg:mt-0 lg:ml-auto">
                        ...
                        <div class="mt-2 text-right">شناسه ملی:
                            ...
                            {{ $business->manager->national_code  ?? '-'}}
                ...
                <div class="intro-y col-span-12 lg:col-span-6">
                    <div class="lg:text-right mt-10 lg:mt-0 lg:mr-auto mr-4">
                        ...
                        <div class="mt-2 text-right">نام شخص حقیقی/حقوقی:&nbsp;&nbsp;
                            ...
                            {{ $invoice->user->full_name ?? 'مصرف کننده نهایی' }}
                        </div>
                        <div class="mt-2 text-right">شناسه ملی:
                        ...
                        <div class="mt-2 text-right">تلفن:&nbsp;&nbsp; {{$invoice->user->phone ?? '-'}}</div>
                        <div class="mt-2 text-right">تلفن همراه:&nbsp;&nbsp; {{$invoice->user->mobile ?? '-'}}</div>
                    </div>
