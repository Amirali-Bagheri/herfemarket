    ...
    <div class="intro-y col-span-12 overflow-auto lg:overflow-visible" style="overflow: auto;">
        ...
        <table class="table table-report -mt-2">
            <thead>
                <tr>
                    <th class="text-center whitespace-no-wrap">
                        <input type="checkbox" class="form-check-input mr-2" @if(count($selected)===$invoices->total()) checked @endif wire:click.lazy="toggleSelectAll">
                    </th>
                    <th class="text-center whitespace-no-wrap">
            ...
            <tbody>
                ...
                <tr class="intro-x">
                    <td>
                        <input type="checkbox" class="form-check-input mr-2" wire:model.defer="selected" value="{{ $invoice->id }}">
                    ...
                    <td class="text-center">{{$invoice->status_name ?? '-'}}</td>
                    ...
                    <td class="table-report__action w-50 text-center">
                        ...
                        <a style="margin: 5px;" href="javascript:void(0)" wire:click="destroy({{$invoice->id}})">
