<div class="dashboard_tab_button">
    <ul role="tablist" class="nav flex-column dashboard-list">
        ...
        <li>
            <a href="{{route('dashboard.business.orders.index')}}" class="nav-link">سفارشات کسب و کار</a>
        </li>
        @endif

        <li>
            <a href="{{route('dashboard.orders.index')}}" class="nav-link">سفارشات</a>
        </li>

        <li>
            <a wire:click="logout" href="#" class="nav-link">خروج</a>
        </li>
    </ul>
</div>
