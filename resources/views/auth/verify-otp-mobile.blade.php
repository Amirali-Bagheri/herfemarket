                    ...
                    <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
                        ...
                        <form wire:submit.prevent="submit">
                            ...
                            <div class="form-group" wire:ignore.self>
                                ...
                                <br>
                                <div class="ls-inputicon-box text-center justify-content-center">
                                    <input class="form-control text-center justify-content-center @error('otp') is-invalid @enderror"
                                           value="{{ old('otp') }}" name="otp" id="otp"
                                           type="text" wire:model.defer="otp"
...
{{--                                <div class="ltr w-100 text-center justify-content-center d-flex" id="otp-group">--}}
