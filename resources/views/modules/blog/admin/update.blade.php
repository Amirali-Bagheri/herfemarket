<div>
    ...
    {{--            @this.emit('categoriesSelected', $('#categories').select2('val'));--}}
    {{--            });--}}

    {{--            $('#categories').val(@this.get('categories')).trigger('change');--}}
                ...
                <div class="intro-y box">
                    ...
                    <div class="p-5">
                        <div class="mt-3" wire:ignore>
                            ...
                            <select id="categories" class="tom-select w-full"
                ...
                <div class="intro-y box">
                    ...
                    <div class="p-5">
                        <div class="mt-3" wire:ignore>
                            ...
                            <textarea
                                data-feature="all"
                                class="tinymce w-full px-3 py-2 text-gray-700 border rounded-lg focus:outline-none @error('description') border-theme-6 @enderror"
                                rows="4"
                                id="description"
                                placeholder="توضیحات"
