<div>
    <div class="intro-y col-span-12 flex flex-wrap sm:flex-no-wrap items-center mt-2 ltr">
        ...
        @if ($product->crawled_product)
            <a href="{{ route('admin.crawled_products.show',$product->crawled_id) }}" class="btn btn-primary shadow-md mr-3">
                مشاهده محصول دریافتی
            </a>
        @endif
                ...
                <div class="intro-y box">
                    ...
                    <div class="p-5">
                        ...
                        <div class="mt-3">
                            ...
                            <input type="text"
                                   class="form-control w-full border mt-2 @error('en_title') border-theme-6 @enderror"
                                   id="en_title" placeholder="نام انگلیسی"
                                   wire:model="en_title">
                            @error('en_title')
                            <div class="text-theme-6 mt-2">{{ $message }}</div> @enderror
                        </div>
                ...
                <div class="intro-y box mt-4">
                    ...
                    <div class="p-5">
                        <div>
                            ...
                            @if (isset($product->brand_id, $product->brand->title))
                                <p class="text-center items-center">انتخاب شده: {{$product->brand->title}}</p>
                        ...
                        @forelse($this->categories as $key => $value)
                                <div class="flex">
                                    <a href="javascript:void(0)" wire:click.prevent="removeCategory('{{$key}}')"><i
                            ...
                            <div class="grid grid-cols-12 gap-6 mt-5">
                                ...
                                @if (isset($category_search_list) and count($category_search_list) > 0)
                                    @foreach($category_search_list as $key_category_search => $value_category_search)
                                        <div class="flex col-span-6 items-center text-gray-700 mt-2">
                                            <input type="checkbox" class="form-control border mr-2" wire:key="{{$key_category_search}}"
                            ...
                            <div class="mt-3">
                                <div class="flex flex-col sm:flex-row mt-2">
                                    <div class="flex items-center text-gray-700 mr-2">
                                        <input type="checkbox" class="form-check-input mr-1 ml-1" id="connect_parent_categories"
                                               name="connect_parent_categories"
                                               wire:model="connect_parent_categories" value="1">
