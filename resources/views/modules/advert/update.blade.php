...
@section('pageTitle','ویرایش تبلیغ')

@section('content')

    {{ Form::model($ad, array('route' => array('admin.ads.update', $ad->id), 'method' => 'PUT', 'enctype' => 'multipart/form-data'))}}
                ...
                <div class="p-5">
                    <div class="form-group">
                        ...
                        <input class="form-control w-full border mt-2 @error('title') border-theme-6 @enderror"
                               ...
                               id="title" value="{{ old('title',$ad->title) }}"/>
                        @error('title')
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control w-full border mt-2 @error('slug') border-theme-6 @enderror"
                               type="text" name="slug"
                               id="slug" value="{{ old('slug',$ad->slug) }}"/>
                        @error('slug')
                        <div class="text-theme-6 mt-2">{{ $message }}</div> @enderror
                    </div>
                    <div class="form-group">
                ...
                <div class="p-5">
                    ...
                    <div class="form-group" v-show="type === 'link'">
                        <input class="form-control w-full border mt-2 @error('image') border-theme-6 @enderror"
                               ...
                               id="image" value="{{ old('image',$ad->image) }}"/>
                        @error('image')
                        <div class="text-theme-6 mt-2">{{ $message }}</div> @enderror
                    </div>
                    <div class="form-group">
    ...
    {{--                    <h3 class="card-title">ویرایش تبلیغ: {{$ad->title}}</h3>--}}
